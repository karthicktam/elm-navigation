...
var author$project$EditPage$init = _Utils_Tuple2(
	{count: 0},
	elm$core$Platform$Cmd$none);
var author$project$Main$EditPage = {$: 'EditPage'};
var author$project$Main$TableList = {$: 'TableList'};
...
var author$project$Main$parser = elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			A2(elm$url$Url$Parser$map, author$project$Main$TableList, elm$url$Url$Parser$top),
			A2(
			elm$url$Url$Parser$map,
			author$project$Main$EditPage,
			elm$url$Url$Parser$s('editPage'))
		]));
var author$project$Main$EditPageRoute = function (a) {
	return {$: 'EditPageRoute', a: a};
};
var author$project$Main$GotEditPageMsg = function (a) {
	...
	function (model, _n0) {
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					page: author$project$Main$EditPageRoute(edit)
				}),
			A2(elm$core$Platform$Cmd$map, author$project$Main$GotEditPageMsg, cmd));
	});
var author$project$Main$GotTableListMsg = function (a) {
	return {$: 'GotTableListMsg', a: a};
};
var author$project$Main$TableListPage = function (a) {
	return {$: 'TableListPage', a: a};
};
var author$project$Main$toTables = F2(
	function (model, _n0) {
		var tables = _n0.a;
		var cmd = _n0.b;
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					page: author$project$Main$TableListPage(tables)
				}),
			A2(elm$core$Platform$Cmd$map, author$project$Main$GotTableListMsg, cmd));
	});
var author$project$TableList$Model = F2(
	function (person, key) {
		return {key: key, person: person};
	});
var author$project$TableList$init = function (key) {
	return _Utils_Tuple2(
		A2(author$project$TableList$Model, _List_Nil, key),
		elm$core$Platform$Cmd$none);
};
...
var author$project$Main$updateUrl = F2(
	function (url, model) {
		...
		if (_n0.$ === 'Just') {
			if (_n0.a.$ === 'EditPage') {
				var _n1 = _n0.a;
				return A2(author$project$Main$toEdit, model, author$project$EditPage$init);
			} else {
				var _n2 = _n0.a;
				return A2(
					author$project$Main$toTables,
					model,
					author$project$TableList$init(model.key));
			}
		} else {
			return _Utils_Tuple2(
				_Utils_update(
...
var author$project$EditPage$update = F2(
	function (msg, model) {
...
var author$project$TableList$update = F2(
	function (msg, model) {
		var route = msg.a;
		return _Utils_Tuple2(
			model,
			A2(elm$browser$Browser$Navigation$pushUrl, model.key, route));
	});
...
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'GotTableListMsg':
				var tablesMsg = msg.a;
				var _n2 = model.page;
				if (_n2.$ === 'TableListPage') {
					var tables = _n2.a;
					return A2(
						author$project$Main$toTables,
						model,
						A2(author$project$TableList$update, tablesMsg, tables));
				} else {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
			default:
				var editMsg = msg.a;
				var _n3 = model.page;
				if (_n3.$ === 'EditPageRoute') {
					var edit = _n3.a;
					return A2(
						author$project$Main$toEdit,
						model,
						A2(author$project$EditPage$update, editMsg, edit));
				} else {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
		}
...
var author$project$EditPage$view = function (model) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
	...
	var links = A2(
		...
		_List_fromArray(
			[
				A2(
				navLink,
				author$project$Main$TableList,
				{caption: 'TableList', url: '/'}),
				A2(
				navLink,
				author$project$Main$EditPage,
				{caption: 'EditPage', url: '/editPage'})
			]));
	return A2(
		elm$html$Html$nav,
		_List_Nil,
...
var author$project$TableList$NavigateTo = function (a) {
...
var author$project$TableList$listView = function (person) {
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text(person.position)
					]))
			]));
};
var author$project$TableList$personList = _List_fromArray(
	[
		{age: 20, name: 'Kumar', position: 'Manager'},
		{age: 30, name: 'Kathir', position: 'Team Leader'},
		{age: 25, name: 'Venkat', position: 'Developer'}
	]);
...
var author$project$TableList$view = function (model) {
	return A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						author$project$TableList$NavigateTo('/editPage')),
				...
				_Utils_Tuple2(
					...
					A2(
						...
						_List_Nil,
						A2(elm$core$List$map, author$project$TableList$listView, author$project$TableList$personList))))
			]));
};
	...
	var content = function () {
		...
		switch (_n0.$) {
			case 'TableListPage':
				...
				return A2(
					elm$html$Html$map,
					author$project$Main$GotTableListMsg,
					author$project$TableList$view(tables));
			case 'EditPageRoute':
				var edit = _n0.a;
				return A2(
					elm$html$Html$map,
					author$project$Main$GotEditPageMsg,
					author$project$EditPage$view(edit));
			default:
