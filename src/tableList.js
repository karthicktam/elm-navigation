...
var author$project$TableList$Modal = function (person) {
...
var author$project$TableList$init = author$project$TableList$Modal(_List_Nil);
...
var author$project$TableList$view = function (modal) {
	return A2(
...
var author$project$TableList$main = elm$browser$Browser$sandbox(
	{init: author$project$TableList$init, update: author$project$TableList$update, view: author$project$TableList$view});
_Platform_export({'TableList':{'init':author$project$TableList$main(
